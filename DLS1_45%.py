...
df2_Ac18 = pd.read_excel('C:\\Work\\Programming\\Paper_3_DLCA\\DLS1.xlsx', 'DLS1_45%_Ac_18y')
df2_Tgr60 = pd.read_excel('C:\\Work\\Programming\\Paper_3_DLCA\\DLS1.xlsx', 'DLS1_45%_Tgr')
dfE2_Hbr40 = pd.read_excel('C:\\Work\\Programming\\Paper_3_DLCA\\DLS1.xlsx', 'DLS1_60%_Hbr')
...
dfE2 = pd.read_excel('C:\\Work\\Programming\\Paper_3_DLCA\\DLS1.xlsx', 'DLS1_60%_Hbr')
...
#S2_Ac_18y
df = pd.read_excel('C:\\Work\\Programming\\Paper_3_DLCA\\DLS1.xlsx', 'DLS1_45%_Ac_18y')
...
#S2_Tgr_60y
df = pd.read_excel('C:\\Work\\Programming\\Paper_3_DLCA\\DLS1.xlsx', 'DLS1_45%_Tgr')
...
#E
df = pd.read_excel('C:\\Work\\Programming\\Paper_3_DLCA\\DLS1.xlsx', 'DLS1_60%_Hbr')
...
def Y_Ac_18y(A2):
    ...
    return 44/12*1000*2212032.3123554*np.exp(4.503-(2.559/A2))
    #return 44/12*1000*2212032.3123554*2.8254*A2
...
def Y_Tgr_60y(T2):
    ...
    return 44/12*1000*2094399.44243021*2.114*(T2**0.941)
...
def Y_Hbr_40y(H1):
    ...
    return 44/12*1000*1.55*2316235.08008013*H1
...
df2_Ac_18y = pd.read_excel('C:\\Work\\Programming\\Paper_3_DLCA\\DLS1.xlsx', 'DLS1_45%_Ac_18y')
df2_Tgr_60y = pd.read_excel('C:\\Work\\Programming\\Paper_3_DLCA\\DLS1.xlsx', 'DLS1_45%_Tgr')
dfE2_Hbr_40y = pd.read_excel('C:\\Work\\Programming\\Paper_3_DLCA\\DLS1.xlsx', 'DLS1_60%_Hbr')
...
writer = pd.ExcelWriter('emissions_seq_DLS1.xlsx', engine = 'xlsxwriter')


df2_Ac_18y.to_excel(writer, sheet_name = 'DLS1_45%_Ac_18y', header=True, index=False)
df2_Tgr_60y.to_excel(writer, sheet_name = 'DLS1_45%_Tgr', header=True, index=False)
dfE2_Hbr_40y.to_excel(writer, sheet_name = 'DLS1_60%_Hbr', header=True, index=False)
...
#read S2_Ac_18y
df = pd.read_excel('emissions_seq_DLS1.xlsx', 'DLS1_45%_Ac_18y')
...
#read S2_Tgr_60y
df = pd.read_excel('emissions_seq_DLS1.xlsx', 'DLS1_45%_Tgr')
...
#read E_Hbr_40y
df = pd.read_excel('emissions_seq_DLS1.xlsx', 'DLS1_60%_Hbr') # can also index sheet by name or fetch all sheets
...
#read S2_Ac_18y
df = pd.read_excel('NonRW_DLS1.xlsx', 'DLS1_45%_Ac_18y')
...
#read S2_Tgr_60y
df = pd.read_excel('NonRW_DLS1.xlsx', 'DLS1_45%_Tgr')
emissions_NonRW_S2_Tgr_60y = df['NonRW_emissions'].tolist()
emissions_NonRW_S2_Tgr_60y_seq = df['kg_CO2_seq'].tolist()


#read E2_Hbr_40y
df = pd.read_excel('NonRW_DLS1.xlsx', 'DLS1_60%_Hbr') # can also index sheet by name or fetch all sheets
...
ax.set_title('Instantaneous GWI, DLS1', fontsize=14)
...
plt.savefig('C:\Work\Data\ID Future Scenarios\_National-scale\Fig_Manuscript\GWIinst_DLS1.svg', dpi=1000,
            bbox_inches = 'tight')
...
ax.set_title('Cumulative GWI, DLS1', fontsize=14)

ax.tick_params(axis='both', labelsize=14)

plt.savefig('C:\Work\Data\ID Future Scenarios\_National-scale\Fig_Manuscript\GWIcum_DLS1.svg', dpi=1000,
            bbox_inches = 'tight')
...
ax.set_title('Dynamic GWP, DLS1', fontsize=14)


plt.savefig('C:\Work\Data\ID Future Scenarios\_National-scale\Fig_Manuscript\GWPdyn_DLS1.svg', dpi=1000,
            bbox_inches = 'tight')
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_DLS1.xlsx', engine = 'xlsxwriter')


dfM_GI.to_excel(writer, sheet_name = 'GWI_Inst_DLS1', header=True, index=False )


dfM_GC.to_excel(writer, sheet_name = 'Cumulative GWI_DLS1', header=True, index=False )


dfM_GWPdyn.to_excel(writer, sheet_name = 'GWPdyn_DL_DLS1', header=True, index=False )
...
writer = pd.ExcelWriter('C_flows_DLS1.xlsx', engine = 'xlsxwriter')


dfM_Ac_18y.to_excel(writer, sheet_name = 'DLS1_45%_Ac_18y', header=True, index=False)
dfE_Tgr_60y.to_excel(writer, sheet_name = 'DLS1_45%_Tgr', header=True, index=False)
dfE_Hbr_40y.to_excel(writer, sheet_name = 'DLS1_60%_Hbr', header=True, index=False)
...
ax2_s.set_title('Carbon flow, DLS1_45%_Ac_18y (symlog-scale)')
...
ax2.set_title('Carbon flow, DLS1_45%_Ac_18y')
...
ax3_s.set_title('Carbon flow, DLS1_45%_Tgr (symlog-scale)')
...
ax3.set_title('Carbon flow, DLS1_45%_Tgr')
...
ax4_s.set_title('Carbon flow, DLS1_60%_Hbr (symlog-scale)')
...
ax4.set_title('Carbon flow, DLS1_60%_Hbr')
...
#Create colum results
dfM_DLS1 = pd.DataFrame.from_dict({'Year':year, 'M_Ac_18y (t-C)':Agg_Cflow_DL_FP_S2_Ac_18y,
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_DLS1.xlsx', engine = 'xlsxwriter')


dfM_DLS1.to_excel(writer, sheet_name = 'DLS1', header=True, index=False)
...
ax5.set_title('Net Carbon Balance, DLS1', fontsize=14)


plt.savefig('C:\Work\Data\ID Future Scenarios\_National-scale\Fig_Manuscript\_NCB_DLS1.svg', dpi=1000,
            bbox_inches = 'tight')
...
df2_amount_Ac18 = pd.read_excel('C:\\Work\\Programming\\Paper_3_DLCA\\NonRW_DLS1.xlsx', 'DLS1_45%_Ac_18y')
...
##NonRW materials/energy amount (F9-0-1)
df2_amount_Tgr60 = pd.read_excel('C:\\Work\\Programming\\Paper_3_DLCA\\NonRW_DLS1.xlsx', 'DLS1_45%_Tgr')
...
##NonRW materials/energy amount (F9-0-1)
dfE2_amount_Hbr40 = pd.read_excel('C:\\Work\\Programming\\Paper_3_DLCA\\NonRW_DLS1.xlsx', 'DLS1_60%_Hbr')
...
writer = pd.ExcelWriter('C_flows_SysDef_DLS1.xlsx', engine = 'xlsxwriter')



dfM_Ac_18y.to_excel(writer, sheet_name = 'DLS1_45%_Ac_18y', header=True, index=False)
dfM_Tgr_60y.to_excel(writer, sheet_name = 'DLS1_45%_Tgr', header=True, index=False)
dfE2_Hbr_40y.to_excel(writer, sheet_name = 'DLS1_60%_Hbr', header=True, index=False)
